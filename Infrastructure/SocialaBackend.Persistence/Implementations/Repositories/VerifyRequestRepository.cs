...
{
    internal class VerifyRequestRepository : GenericRepository<VerifyRequest>, IVerifyRequestRepository
    {
        public VerifyRequestRepository(AppDbContext context) : base(context)
        {
        }
    }
}
