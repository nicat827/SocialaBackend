...
namespace SocialaBackend.Persistence.Implementations.Services
{
    internal class UserService : IUserService
    {
        ...
        public async Task RegisterAsync(AppUserRegisterDto dto)
        {
            ...
            string url = $"https://socialite827.netlify.app/confirm?token={validEmailToken}&email={newUser.Email}";
        ...
        public async Task ResetPasswordAsync(string email)
        {
            ...
            string url = $"https://socialite827.netlify.app/reset?token={validResetToken}&email={user.Email}";
