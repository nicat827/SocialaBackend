...
namespace SocialaBackend.Persistence.DAL.Migrations
{
    ...
    [Migration("20240210071635_EntitiesForStoryAddedOneToOneRelationForUserAndStoryCreated")]
    partial class EntitiesForStoryAddedOneToOneRelationForUserAndStoryCreated
    {
            ...
            modelBuilder.Entity("SocialaBackend.Domain.Entities.Story", b =>
                {
                    b.HasOne("SocialaBackend.Domain.Entities.User.AppUser", "AppUser")
                        .WithOne("Story")
                        .HasForeignKey("SocialaBackend.Domain.Entities.Story", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
